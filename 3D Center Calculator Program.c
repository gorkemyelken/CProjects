...
int main()
{
    printf("*****3D Center Calculator Program*****\n\n\n");
    // Descriptions
    printf("With 3D center calculator, you can calculate the center point of a 3D object.\n");
    printf("As instruction, you need to make a file which is in the same folder with your program and name of the file should be teapot.obj, then you will have the centre coordinates after running the program.\n\n\n"); 
    char f_or_v;
    float x, y, z;
